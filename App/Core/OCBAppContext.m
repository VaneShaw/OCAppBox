...
{
    _environment = environment.length > 0 ? [environment copy] : @"development";

    id<OCBNetworking> network = [self.serviceRegistry serviceForProtocol:@protocol(OCBNetworking)];
    [network useEnvironment:_environment];
}
